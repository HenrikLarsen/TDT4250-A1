 ...
 *   <li>{@link Program.impl.SpecializationImpl#getCode <em>Code</em>}</li>
...
public class SpecializationImpl extends MinimalEObjectImpl.Container implements Specialization {
	...
	public void setCode(String newCode) {
		...
		code = newCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProgramPackage.SPECIALIZATION__CODE, oldCode, code));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProgramPackage.SPECIALIZATION__NAME:
				return getName();
			case ProgramPackage.SPECIALIZATION__CODE:
				return getCode();
			case ProgramPackage.SPECIALIZATION__SEMESTERS:
				return getSemesters();
			case ProgramPackage.SPECIALIZATION__SPECIALIZATIONS:
